#include "Cemara.h"
Cemara::Cemara(QWidget * parent):QWidget(parent)
{
    setWindowTitle(tr("Cemara"));
}
QImage Cemara::IplImageToQImage(const IplImage * iplImage,double mini, double maxi)
{
...
void Cemara::paintEvent(QPaintEvent *){
    QPainter painter(this);
    painter.drawImage(QPoint(0,0), image);
}

bool Cemara::ShowImage(){
