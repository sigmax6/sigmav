...
int _main(int argc, char *argv[])
{
	...
	maptab.add(Segment("timer", TIMER_BASE, TIMER_SIZE, IntTab(1), false));
	...
	soclib::caba::VciXcacheWrapper<vci_param, soclib::common::Mips32ElIss > cache4("cache4", 4, maptab,IntTab(4), 4,1,8, 4,1,8);
	soclib::caba::VciXcacheWrapper<vci_param, soclib::common::Mips32ElIss > cache5("cache5", 5, maptab,IntTab(5), 4,1,8, 4,1,8);
	soclib::caba::VciXcacheWrapper<vci_param, soclib::common::Mips32ElIss > cache6("cache6", 6, maptab,IntTab(6), 4,1,8, 4,1,8);
	soclib::caba::VciXcacheWrapper<vci_param, soclib::common::Mips32ElIss > cache7("cache7", 7, maptab,IntTab(7), 4,1,8, 4,1,8);
	...
	soclib::caba::VciTimer<vci_param> vcitimer("vcitimer", IntTab(1), maptab, 8);

	soclib::caba::VciVgmn<vci_param> vgmn("vgmn",maptab, 8, 3, 2, 8);
	...
	vgmn.p_to_initiator[4](signal_vci_m4);
	vgmn.p_to_initiator[5](signal_vci_m5);
	vgmn.p_to_initiator[6](signal_vci_m6);
	vgmn.p_to_initiator[7](signal_vci_m7);

	vgmn.p_to_target[0](signal_vci_vcimultiram0);
	vgmn.p_to_target[1](signal_vci_vcitimer);
