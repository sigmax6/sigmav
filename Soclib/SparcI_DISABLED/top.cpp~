...
int _main(int argc, char *argv[])
{
	...
	soclib::common::MappingTable maptab(32, IntTab(8), IntTab(8), 0x00300000);
        ...
        // 4: mask code 20000000 means 00100000.....
        //    and used by the cache controller for determining if an address is cacheable or not
        ...
        //There is only one bit of mask code so the cacheability table will be:
        //   TTY_BASE  A0000000 -> 1010....
        //   DATA_BASE 10000000 -> 0001....
        //   TEXT_BASE 00000000 -> 0000....
        //  TIMER_BASE B0000000 -> 1011....
        //   MASK_CODE 20000000 -> 0010....
        //
        //                           1  false
        //                           0  true
        //                           0  true
        //                           1  false
        //
        //   So Xcache module will see 1 as false and 0 as true
        //
...
//	    sparc v8 have only 4 interupts
    ...
    sc_signal<bool> signal_timer_irq2("signal_timer_irq2");
    sc_signal<bool> signal_timer_irq3("signal_timer_irq3");

        //Connet the timer to the vgmn
	...
	soclib::caba::VciSignals<vci_param> signal_vci_tty("signal_vci_tty");
        ...
        //Initiate the Xcache
	soclib::caba::VciXcacheWrapper<vci_param, soclib::common::Sparcv8Iss<8> > sparc0("sparc", 0, maptab,IntTab(0), 4,1,8, 4,1,8);
	...
	soclib::caba::VciMultiTty<vci_param> vcitty("vcitty",	IntTab(1), maptab, "vcitty0", NULL);
        ...
        // Initiate the Timer
    soclib::caba::VciTimer<vci_param> vcitimer("vcitimer", IntTab(2),maptab,1);
        // 1: name
        // 2: vci target id in IntTab
        // 3: maptab
        // 4: timer ports
...
//
    ...
    vcitimer.p_irq[0](signal_sparc0_it0);
//    vcitimer.p_irq[1](signal_sparc0_it1);
//    vcitimer.p_irq[2](signal_sparc0_it2);
//    vcitimer.p_irq[3](signal_sparc0_it3);
//    vcitimer.p_irq[1](signal_timer_irq1);
//    vcitimer.p_irq[2](signal_timer_irq2);
//    vcitimer.p_irq[3](signal_timer_irq3);
