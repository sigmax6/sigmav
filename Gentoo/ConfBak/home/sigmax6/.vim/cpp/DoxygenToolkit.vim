...
function! <SID>DoxygenCommentFunc()
  ...
  for key in keys( l:types )
    ...
    if( l:name != "" )
      "call s:WarnMsg( "[DEBUG] key:".key." name:".l:name )
      "call s:WarnMsg( "[DEBUG] key:".key." name:".l:name )
      let l:doc.type = key
  ...
  if( g:DoxygenToolkit_compactOneLineDoc =~ "yes" && l:doc.returns != "yes" && len( l:doc.params ) == 0 )
    ...
    "Add by nijia
    """""""""""""""""""""""""""""""""
    " class / namespace / struct / enum / fn
    if( ( l:doc.type == "class" && g:DoxygenToolkit_briefTag_className == "yes" ) || ( l:doc.type == "struct" && g:DoxygenToolkit_briefTag_structName == "yes" ) || ( l:doc.type == "enum" && g:DoxygenToolkit_briefTag_enumName == "yes" ) || ( l:doc.type == "namespace" && g:DoxygenToolkit_briefTag_namespaceName == "yes" ) )
      exec "normal ".l:insertionMode.s:interCommentTag."@".l:doc.type." "
      if( l:doc.name != "None" )
        exec "normal A".l:doc.name
      endif
    elseif ( l:doc.type == "function" && g:DoxygenToolkit_briefTag_funcName == "yes" )
      exec "normal ".l:insertionMode.s:interCommentTag."@fn "
      if( l:doc.name != "None" )
        exec "normal A".l:doc.name
      endif
    endif
